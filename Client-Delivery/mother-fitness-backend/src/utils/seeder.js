...
const seedDatabase = async () => {
    try {
        ...
        const customersWithCreator = sampleCustomers.map((customer, index) => ({
            ...customer,
            customerId: 'cust_' + Date.now() + '_' + Math.random().toString(36).substr(2, 9),
            memberId: 'U' + String(1001 + index), // Explicit unique ID
        ...
        logger.info('Staff - Email: staff@motherfitness.com, Password: 0000');
